...
#PBS -m a
#PBS -N helg-polish
#PBS -o /g/data/xl04/al4518/analysis/polish-genomes/scripts/joblogs/nextpolish-hydrophis_elegans.log
#PBS -j oe
...
ASM="${DIR}/genomes/hydrophis_elegans-consensus.fasta"
OUT="${DIR}/results"

# Assembly basename
BN=$(basename ${ASM%-*})

R1='/g/data/xl04/al4518/analysis/polish-genomes/seqs/Hydrophis_elegans-KLS1121_R1.fastq.gz'
R2='/g/data/xl04/al4518/analysis/polish-genomes/seqs/Hydrophis_elegans-KLS1121_R2.fastq.gz'
