# ------------------------------------------------------------------------------------------------ #
# Plot BUSCO: Hydrophis elegans after primary assembly, nanopore polish and short-read polish
#
...
# Legend
my_title <- expression(paste("BUSCO assessment: ", italic("Hydrophis elegans"), ' assembly progress'))
...
# Load files
files <- dir_ls(
  path = here('assembly', 'other-snakes','genome_assessment','busco','hydrophis_elegans'),
  glob = '*.txt',
  recurse = TRUE
) %>%
  as.character() %>%
