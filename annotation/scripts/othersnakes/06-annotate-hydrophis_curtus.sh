...
#PBS -l wd
#PBS -N Hc-annotate
#PBS -o /home/566/al4518/al/annotation/scripts/joblogs/funannotate-annotate-hydrophis_curtus.log
#PBS -j oe

# Variables
DIR='/g/data/xl04/al4518/annotation/hydrophis_curtus'
EGG="${DIR}/annotation-funannotate/emapper-annotation/Hydrophis_curtus-emapper.emapper.annotations"
IPS="${DIR}/annotation-funannotate/interpro-annotation/Hydrophis_curtus.xml"
